...
각 항목의 근거는 _archive_v8_contest/validation/V1_점검표비교_v3.xlsx 매핑 결과를 참고하여 정리.
...
# 디자인실 — 미술실과 유사한 환경 (스프레이·접착제·커터칼 등) 으로 LAB_SPACES 포함
LAB_SPACES = [
    "화학실", "물리실", "생명과학실", "지구과학실",
    "기술실", "가정실", "미술실", "디자인실",
]
...
LAW_BASIS: dict[str, dict] = {
    ...
    "국소배기장치": {
        ...
        "law": "산업안전보건법",
        "article": "제114조",
        "note": "유해가스·증기 배출 — 스프레이·본드 사용 디자인실도 권장",
        "applicable_spaces": ["화학실", "기술실", "미술실", "디자인실"],
    },
    "기계환기구": {
        "category": "환기·배기",
        "weight": 6,
    ...
    "장갑": {
        ...
        "law": "산업안전보건법",
        "article": "제38조",
        "note": "화학물질·접착제·커터칼 접촉 방지",
        "applicable_spaces": ["화학실", "생명과학실", "가정실", "미술실", "디자인실"],
    },
    "방독면": {
        "category": "개인보호구",
        "weight": 6,
    ...
    "MSDS비치": {
        ...
        "law": "산업안전보건법",
        "article": "제114조",
        "note": "물질안전보건자료 비치·교육 — 스프레이·본드 사용 디자인실 포함",
        "applicable_spaces": CHEM_SPACES + ["기술실", "가정실", "디자인실"],
    },
    "안전수칙게시": {
        "category": "안내·표지",
        "weight": 5,
